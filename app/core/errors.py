...
class ErrorCode:
    ...
    # Graph & Correlation (GRAPH-xxx)
    GRAPH_CYCLE_DETECTED = "GRAPH-001"
    GRAPH_MAX_DEPTH_EXCEEDED = "GRAPH-002"
    GRAPH_INVALID_RELATIONSHIP = "GRAPH-003"
    GRAPH_ENTITY_NOT_FOUND = "GRAPH-004"
